        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="border border-gray-800 rounded-lg p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              SRM students graduate with deep, demonstrable expertise that
              remains valuable in an AI-augmented world — not because they can
              outperform AI on routine tasks, but because they know how to think
              critically, build effectively, and lead responsibly alongside it.
            </p>
          </div>
          ...
          <div className="border border-emerald-900/40 bg-emerald-950/10 rounded-lg p-8">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              content, and learning experiences for the broader student body.
            </p>
            <div className="space-y-3 mt-6">
              {[
                "Research AI's impact on white-collar careers and industries",
                "Map the skills that stay valuable in a post-AI job market",
                "Build curricula and learning materials to teach those skills",
                "Distribute knowledge at scale across SRM's student community",
              ].map((item) => (
